...
// Updated to use the correct model name - gemini-1.5-flash or gemini-1.5-pro
const GEMINI_API = `https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=AIzaSyAPCb3-w95aDZlLpHw6BQo9EHeVYy247tM`;
