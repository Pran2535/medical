...
// Using v1 API endpoint with gemini-1.5-flash
const GEMINI_API = `https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=AIzaSyAPCb3-w95aDZlLpHw6BQo9EHeVYy247tM`;
