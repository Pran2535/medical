...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block fixed bottom-6 right-6 z-50">
        {!isOpen && (
          <button
            ...
            className="relative bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 text-white p-5 rounded-full shadow-2xl hover:shadow-emerald-500/50 hover:scale-110 transition-all duration-300 animate-pulse hover:animate-none"
      ...
      {/* Chatbox */}
      {isOpen && (
        <div className="hidden lg:flex flex-col fixed bottom-6 right-6 w-[420px] h-[600px] bg-white dark:bg-gray-900 rounded-2xl shadow-2xl z-50 overflow-hidden border border-gray-200 dark:border-gray-700 transform transition-all duration-300">
          {/* Header */}
          <div className="relative p-5 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-600 text-white">
            <div className="flex justify-between items-center">
              ...
              <button 
                ...
                className="w-9 h-9 rounded-full hover:bg-white/20 transition-colors flex items-center justify-center group"
          ...
          {/* Messages Container */}
          <div className="flex-1 p-5 overflow-y-auto bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-800 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
