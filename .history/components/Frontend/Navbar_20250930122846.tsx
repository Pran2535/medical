...
const products = [
  { name: 'Video Conferencing', description: 'Get a quick doctor discussion ', href: '#', icon: ChartPieIcon },
  { name: 'Book sessions with doctors', description: 'skip the waiting queue', href: '#', icon: CursorArrowRaysIcon },
  { name: 'Get Message', description: 'Need a messager we are here to provide', href: '#', icon: FingerPrintIcon },
  { name: 'Emergency', description: 'Get the emergency ward in nearby hospital', href: '#', icon: SquaresPlusIcon },
  { name: 'Health Tracker', description: 'Track your health and get report', href: '#', icon: ArrowPathIcon },
]
const callsToAction = [
    ...
    <header className="bg-gray-900 sticky top-0 z-50">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="text-sm/6 font-semibold text-white bg-blue-600 py-3 px-6 rounded-md hover:bg-blue-700">
