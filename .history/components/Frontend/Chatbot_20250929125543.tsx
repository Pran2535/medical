...
const Chatbot = () => {
 ...
 const GEMINI_API = `https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-pro:generateContent?key=${process.env.NEXT_PUBLIC_GEMINI_API_KEY}`;
  const sendMessage = async () => {
    ...
    try {
      ...
      console.error(err);
      setMessages([...updatedMessages, { sender: 'bot', text: '❌ Error reaching AI. Try later.' }]);
    } finally {
      setLoading(false);
    }
  };
