                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-4 flex gap-3">
                      ...
                      <Link href="/book-appointment">
                        <button className="bg-transparent border border-gray-700 hover:bg-gray-800 cursor-pointer px-3 py-2 rounded-md text-sm">
                          Book Doctor
                        </button>
                      </Link>
                    </div>
              ...
              <div key={i} className="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 hover:shadow-2xl transition-all">
                <div className="flex flex-col items-center">
                  ...
                  <div className="mt-4 w-full">
                    <Link href="/book-appointment">
                      <button className="w-full bg-blue-600 hover:bg-blue-700 py-2 rounded-md cursor-pointer font-semibold">Book Appointment</button>
                    </Link>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {packages.map((pkg, i) => (
              <div key={i} className="bg-gray-800 p-6 rounded-2xl border border-gray-700 hover:shadow-xl transition">
                ...
                <div className="mt-4">
                  <button className="w-full bg-blue-600 hover:bg-blue-700 py-2 rounded-md cursor-pointer font-semibold">Book Package</button>
                </div>
              </div>
            ))}
          </div>
