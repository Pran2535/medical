...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 lg:py-20">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12">
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
            <span className="font-semibold text-blue-600">Medicure</span> is a comprehensive healthcare platform designed to bridge the gap between patients and quality medical care. Founded with the vision of eliminating long waiting times and making healthcare accessible to all, we leverage cutting-edge technology to deliver seamless medical services.
          </p>
          <p className="text-lg text-gray-700 leading-relaxed mb-6">
      ...
      {/* Services Section */}
      <section className="max-w-6xl mx-auto px-6 py-16 lg:py-20 bg-gradient-to-br from-blue-50 to-transparent rounded-3xl">
        <div className="text-center mb-12">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="group bg-white rounded-2xl shadow-lg p-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer border-2 border-transparent hover:border-blue-500"
            >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Reduce Wait Times</h3>
                  <p className="text-gray-600">Eliminate long queues and waiting periods through smart scheduling and real-time availability updates.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Connect with Best Doctors</h3>
                  <p className="text-gray-600">Curated network of verified, experienced doctors and specialists across multiple disciplines.</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Accessible Healthcare</h3>
                  <p className="text-gray-600">Breaking geographical barriers to make quality healthcare accessible in urban and rural areas alike.</p>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-2">Empower Patients</h3>
                  <p className="text-gray-600">Providing tools and information to help patients make informed decisions about their health.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* AI Features Section */}
      <section className="max-w-6xl mx-auto px-6 pb-16 lg:pb-20">
        <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 rounded-3xl shadow-xl p-8 md:p-12 overflow-hidden relative">
          ...
          <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Smart Appointment Matching</h3>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Predictive Wait Time</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">Intelligent Scheduling</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="mt-8 bg-white/60 backdrop-blur-sm rounded-2xl p-6 border-2 border-blue-200">
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                  <Calendar className="w-6 h-6 text-blue-600" />
                </div>
                <div>
                  <h4 className="font-bold text-gray-900 mb-2">How AI Streamlines Your Booking</h4>
