...
const Stats = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 -mt-12 grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
      {stats.map((stat, i) => (
        <div key={i} className="bg-black rounded-2xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow">
          <div className="inline-flex items-center justify-center w-12 h-12 bg-blue-100 text-white-600 rounded-full mb-3">{stat.icon}</div>
